   ...
   if (roomType === "Chambre Elise") {
        numPeopleSelect.add(new Option("1 personne", "1"));
        numPeopleSelect.add(new Option("2 personnes", "2"));
      } else if (roomType === "Chambre Alexandra" ||roomType === "Chambre Olympe" ) {
        numPeopleSelect.add(new Option("1 personne", "1"));
        numPeopleSelect.add(new Option("2 personnes", "2"));
        numPeopleSelect.add(new Option("3 personnes", "3"));
        ...
        numPeopleSelect.add(new Option("2 personnes", "2"));
        numPeopleSelect.add(new Option("3 personnes", "3"));
        numPeopleSelect.add(new Option("4 personnes", "4"));
      }
    }
    //desktop
    function openModal() {
